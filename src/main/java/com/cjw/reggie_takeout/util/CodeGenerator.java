...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/reggie?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&useSSL=false");
        ...
        //设置生成包的父路径
        pc.setParent("com.cjw.reggie_takeout");
        //设置生成实体类的包名
        pc.setEntity("pojo");
